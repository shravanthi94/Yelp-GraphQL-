...
import { addMenuItemMutation } from '../../../mutations/mutations';
import styles from './form.module.css';

const AddMenu = ({ addMenuItemMutation }) => {
  ...
  const onSubmit = async (e) => {
    ...
    const mutationResponse = await addMenuItemMutation({
      variables: {
    ...
    if (mutationResponse) {
      const response = mutationResponse.data.addMenu;
...
export default graphql(addMenuItemMutation, {
